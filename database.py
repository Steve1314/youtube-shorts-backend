...
MONGO_URI = os.getenv("MONGO_URI", "mongodb+srv://vahlaydigital_db_user:GWOLQNfkkC6HZo15@cluster0.kaixweg.mongodb.net/?appName=Cluster0&tls=true&tlsAllowInvalidCertificates=true")
